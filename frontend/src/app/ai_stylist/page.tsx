    ...
    const handleSubmit = async (event: React.FormEvent) => {
      ...
      try {
        ...
        if ('error' in locationResponse.data) {
          ...
          country = locationResponse.data.countryCode;
        }
      }
      catch (error) {
    ...
    <div className="max-w-4xl mx-auto mt-5 min-h-screen">
        ...
        <div className="flex items-center justify-center w-full mb-4">
          <label htmlFor="dropzone-file" className="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100">
            <div className="flex flex-col items-center justify-center pt-5 pb-6">
              <svg className="w-2 h-2 mb-3  " fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12"></path></svg>
      ...
      {geminiResponse.length > 0 && (
        <div className="mt-8">
          ...
          <p className="  mb-2">Based on the image you uploaded, our AI Stylist suggests the following:</p>
